        ...
        <div class="main-container">
            ...
            <div class="main-content">
                <div class="new-product">
                    ...
                    <div class="item-container">
                        <div class="promo-item"><a href="chitietsanpham.html?productId=5"><img
                                    src="../assets/images/products/sonywh1000xm4.jpg"></a></div>
                        <div class="new-items"><a href="chitietsanpham.html?productId=1">
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=9">
                                <div class="new-items-img"><img src="../assets/images/products/airpod_3.jpg" alt=""></div>
                                <div class="new-items-data">
                                    <div class="new-items-data--title" href="chitietsanpham.html?productId=9">
                                        <p>Apple Airpod 3</p>
                                    </div>
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=10">
                                <div class="new-items-img"><img src="../assets/images/products/wf1000xm4.jpeg" alt="">
                                </div>
                                <div class="new-items-data">
                                    <div class="new-items-data--title" href="chitietsanpham.html?productId=10">
                                        <p>Sony WF-1000XM4</p>
                                    </div>
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=18">
                                <div class="new-items-img"><img src="../assets/images/products/moondrop_kato.jpg" alt="">
                                </div>
                                <div class="new-items-data">
                                    <div class="new-items-data--title" href="chitietsanpham.html?productId=18">
                                        <p>Moondrop KATO</p>
                                    </div>
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=23">
                                <div class="new-items-img"><img src="../assets/images/products/moondrop_blessing2.jpg"
                                        alt=""></div>
                                <div class="new-items-data">
                                    <div class="new-items-data--title" href="chitietsanpham.html?productId=23">
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=3">
                                <div class="new-items-img"><img src="../assets/images/products/focal_radiance.jpeg" alt="">
                                </div>
                                <div class="new-items-data">
                                    <div class="new-items-data--title" href="chitietsanpham.html?productId=3">
                                        <p>Focal Radiance</p>
                                    </div>
            ...
            <div class="main-content">
                <div class="new-product">
                    ...
                    <div class="item-container">
                        <div class="new-items"><a href="chitietsanpham.html?productId=2">
                                <div class="new-items-img"><img src="../assets/images/products/focal_celestee.jpg" alt="">
                                </div>
                                <div class="new-items-data">
                                    <a class="new-items-data--title" href="chitietsanpham.html?productId=2">
                                        <p>Focal Celestee</p>
                                    </a>
                                    <div class="newprice">29.990.000 đ</div>
                                </div>
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=8">
                                <div class="new-items-img"><img src="../assets/images/products/airpod_pro.jpg" alt="">
                                </div>
                                <div class="new-items-data">
                                    <a class="new-items-data--title" href="chitietsanpham.html?productId=8">
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=11">
                                <div class="new-items-img"><img src="../assets/images/products/wfc500.jpg" alt="">
                                </div>
                                <div class="new-items-data">
                                    <a class="new-items-data--title" href="chitietsanpham.html?productId=11">
                                        <p>Sony WF-C500</p>
                                    </a>
                        ...
                        <div class="new-items"><a href="chitietsanpham.html?productId=20">
                                <div class="new-items-img"><img src="../assets/images/products/moondrop_starfield.png" alt="">
                                </div>
                                <div class="new-items-data">
                                    <a class="new-items-data--title" href="chitietsanpham.html?productId=20">
