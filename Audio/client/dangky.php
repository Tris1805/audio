          ...
          <div class="login_card_containter">
            <div class="login_card">
              ...
              ?>
                ...
                if (!$result) {
                  echo '<div class="invalid_username">Username have already existed</div>';
                } else if (strlen($password) < 8 || strpos($password, ' ') !== false) {
                  echo '<div class="wrong_password">Password must be more than 8 characters</div>';
                } else if ($password != $confirm_password) {
                  echo '<div class="wrong_password">Wrong Password Confirmation</div>';
                } else if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                  echo '<div class="invalid_email">Invalid Email</div>';
                } else if (!preg_match('/^(03|05|07|08|09)+([0-9]{8})\b/', $phone_number)) {
                  echo '<div class="invalid_tel">Invalid Tel</div>';
            ...
            <form action="" method="post" class="login_card_form">
              ...
              <div class="form_item">
                <span class="form_item_icon material-symbols-rounded">lock</span>
                <input type="password" placeholder="Confirm password" required autofocus id="re-password"
                  name="re-password">
              </div>
              <div class="form_item">
