...
function changeMap() {
    ...
    if (targetMap2.style.display !== "none" || targetMap3.style.display !== "none") {
...
function changeMap2() {
    ...
    if (targetMap1.style.display !== "none" || targetMap3.style.display !== "none") {
...
function changeMap3() {
    ...
    if (targetMap1.style.display !== "none" || targetMap2.style.display !== "none") {
        targetMap1.style.display = "none";
        targetMap2.style.display = "none"; 
      } else {
